...
you also have to change `yourNumber` in `message.author == "yourNumber"` in line 33 and 39 in [onMessage.js](onMessage.js) to your Whatsapp Number so only you have excess to the command you can also `remove  && message.author == "yourNumber"` completely but it is not recommended <br>
